...
function rehypePrettyCode(options = {}) {
    const { grid = true, theme = 'github-dark-dimmed', keepBackground = true, tokensMap = {}, filterMetaString = (v)=>v, getHighlighter = shiki.getHighlighter, onVisitLine, onVisitHighlightedLine, onVisitHighlightedChars, onVisitTitle, onVisitCaption } = options;
